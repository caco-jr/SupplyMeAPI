...
public class Anuncio {
	...
	public Anuncio(String title, String category_id, Double price, String currency_id, int available_quantity,
			String buying_mode, String listing_type_id, String condition, String description, String video_id,
			String warranty, List<Picture> pictures) {
		super();
		this.title = title;
